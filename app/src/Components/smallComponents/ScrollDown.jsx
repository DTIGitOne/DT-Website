...
const ScrollDown = ({section}) => {
    return(
        <FramerOne del={0.1} dur={0.7} classes="flex justify-center items-center bottom-1" position={"absolute"} height='auto' var1={{opacity: 0, y: -75}} var2={{opacity: 1,y: 0}} width='100%'>
